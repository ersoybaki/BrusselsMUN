...
const cards = [
  {
    ...
    description:
      "Explore real negotiation dynamics through case-based sessions and interactive discussions.",
  },
  {
    image: Conference1,
    title: "Next-Gen Leadership",
    description:
      "Build the skills and network needed to lead in international affairs and governance.",
  },
  {
    image: Conference2,
    title: "Governance & Impact",
    description:
      "Turn ideas into policy by focusing on evidence, feasibility, and measurable outcomes.",
  },
];
